...
class TranslationSkillContractTests(unittest.TestCase):
    ...
    def test_skill_requires_grounded_unofficial_translations(self) -> None:
        ...
        required_phrases = (
            ...
            "Preserve verified English WoW entity names exactly",
            "terminology.json",
            "validate_translations.py",
            "numbers, percentages, durations",
            "uncertain terminology",
            "Unknown suspected names remain a hard blocker",
            "Do not translate a verified WoW entity name",
            ...
            "Do not store a duplicate `esES` localization under `esMX`",
        )
